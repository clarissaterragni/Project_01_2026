...
Links and notes that were useful during development and I wanted to keep for reference are in sources&useful.md
Details regarding the use of AI tools can be found in AI_USAGE.md
